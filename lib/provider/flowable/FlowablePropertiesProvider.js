...
var getListenerLabel = function(listener, translate) {
  ...
  if (is(listener, 'flowable:CaseExecutionListener')) {
  ...
  if (is(listener, 'flowable:VariableListener')) {
 ...
 */
function FlowablePropertiesProvider(eventBus, cmmnFactory, elementRegistry, itemRegistry, cmmnRules, translate) {
